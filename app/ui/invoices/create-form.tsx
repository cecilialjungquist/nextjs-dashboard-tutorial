...
import { createInvoice } from '@/app/lib/actions'; // This is a Server Action!

// Good to know: In HTML, you'd pass a URL to the action attribute. This URL
// would be the destination where your form data should be submitted 
